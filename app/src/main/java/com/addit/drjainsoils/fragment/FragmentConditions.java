...
import com.addit.drjainsoils.pairs.members;
...
public class FragmentConditions extends XFragment {
    String data = "";
    TextView result;
    RequestQueue queue;
    CheckBox c1;
    ...
    public static FragmentConditions newInstance() {
        return new FragmentConditions();
    }
    ...
    protected void getXmlViews(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) getActivity().findViewById(R.id.recycler2);
    ...
    protected void initXmlViews(View view) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                adapter.addItem(new members(a.getString("NAME"),a.getString("URL"), i + 1));

            }
            adapter.notifyDataSetChanged();
            //showToast(Integer.toString(adapter.getCount()));
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        JSONObject a = null;
                        a = array.getJSONObject(i);
                        String search=a.getString("NAME");
                        if(search.contains(cs.toString().trim()))
                        adapter.addItem(new members(a.getString("NAME"),a.getString("URL"), i + 1));
                ...
                if(!(arg0.toString().trim()==null)){
                    ...
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            a = array.getJSONObject(i);
                            String search=a.getString("NAME");
                            if(search.contains(arg0.toString().trim()))
                                adapter.addItem(new members(a.getString("NAME"),a.getString("URL"), i + 1));
