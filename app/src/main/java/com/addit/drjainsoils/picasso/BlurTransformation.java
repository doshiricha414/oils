package com.addit.drjainsoils.picasso;
...
// you need to load image again, after picasso calls onSuccess callback

public class BlurTransformation implements com.squareup.picasso.Transformation {

    @Override
    public Bitmap transform(final Bitmap source) {
        Bitmap blurred = fastBlur(AppContext.getContext(), source, 10);
        source.recycle();
        return blurred;
    }
